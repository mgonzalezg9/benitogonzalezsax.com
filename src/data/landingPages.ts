...
export const buildCityPageData = (location: LocationEntry): LandingPageData => ({
  ...
  answerBlockTitle: `Respuesta rapida para bodas en ${location.city}`,
  answerBlockIntro: `Datos claros para entender rapido que ofrece Benito Gonzalez Sax en ${location.city}, como trabaja y como reservar.`,
