...
export const buildEnglishCityPageData = (location: LocationEntry): LandingPageData => {
  ...
  return {
    ...
    eventServices: sharedEventServices,
    serviceTitle: `What services does a saxophonist cover in ${place}`,
    serviceDescription: `Every wedding or event is different, so the service adapts to the style, venue and moments you want to highlight in ${place} and nearby areas.`,
    moments: sharedMoments,
